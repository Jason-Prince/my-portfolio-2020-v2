...
const Project = styled.div`
  ...
  @media (min-width: 768px) {
    ...
    grid-template-columns: ${({ cook, pixabay, portfolio }) =>
      cook
        ? "1fr minmax(23em, 1fr) minmax(auto, 40em)"
        : pixabay
        ? "minmax(auto, 40em) minmax(23em, 1fr) 1fr"
        : portfolio
        ? "1fr minmax(23em, 1fr) minmax(auto, 40em)"
        : ""};
    grid-template-rows: 1fr;
    grid-template-areas: ${({ cook, pixabay, portfolio }) =>
      cook
        ? `". details screenshot"`
        : pixabay
        ? `"screenshot details ."`
        ...
        ? `". details screenshot"`
        : `""`};
    justify-items: ${({ cook, pixabay, portfolio }) =>
      cook ? "end" : pixabay ? "start" : portfolio ? "end" : "center"};
  }
`;
      ...
      <Section>
        ...
        <Contact id="contact">
          ...
          >
            ...
            <SvgLabel>Jason-C-Prince</SvgLabel>
          </SvgLink>
          <SvgLink
            github
          ...
          >
            ...
            <SvgLabel>Jason-Prince</SvgLabel>
          </SvgLink>
          <SvgLink phone>
            ...
            <SvgLabel>‪(415) 498-0783‬</SvgLabel>
          </SvgLink>
          <SvgLink
            email
            href="mailto:jasoncprince@gmail.com?Mail From Portfolio Site"
          >
            ...
            <SvgLabel>Jason.C.Prince@gmail.com</SvgLabel>
          </SvgLink>
        </Contact>
